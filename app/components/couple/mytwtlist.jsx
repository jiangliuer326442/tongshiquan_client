...
class MyTwtlist extends Component {
	...
	refresh_twt(page, cb){
		...
		getmyowntwt(page, pagenum, uid, token, dispatch, cb);
	}
...
{this.props.list.map((item, index)=>{
	return(
				<Twtitem source="mytwt" twtitem={item} twtindex={index} />
	)			
})}
			</div>
		)
...
export default connect(mapStateToProps)(MyTwtlist);